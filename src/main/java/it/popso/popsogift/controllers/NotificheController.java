...
import it.popso.popsogift.dto.EsitoDTO;
...
public class NotificheController {
    ...
    public EsitoDTO leggiNotifica(@RequestHeader("Ruolo") String ruolo,
                                  @RequestHeader("Matricola")String matricola,
                                  @PathVariable int id) {
        try {
        ...
        return new EsitoDTO(HttpStatus.OK.name(), "Notifica letta con successo");
    }
}
